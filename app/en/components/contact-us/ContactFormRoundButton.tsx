...
const ContactFormRoundButton = () => {
   return (
      <section className="py-16 sm:py-20 md:py-24 lg:py-28 bg-base-100 px-5 sm:px-0">
         <div className="container mx-auto">
            ...
            <div className="flex flex-wrap md:flex-nowrap lg:grid lg:grid-cols-7 md:gap-6 mt-12">
               <div className="lg:col-span-5 sm:p-6 lg:p-10 rounded-xl w-full">
               ...
               <div className="lg:col-span-2 space-y-8 mt-6 md:mt-0 w-full">
                  {/* box 1 */}
                  <div className="pb-3 lg:pb-8 border-b border-base-content/10 w-full">
                  ...
                  {/* box 3 */}
                  <div className="pb-3 lg:pb-8 w-full">
                     <div className="flex items-center justify-center bg-primary rounded-full w-10 h-10 mx-auto p-3 mb-6">
                        <svg
                           width="12"
                           height="18"
...
export default ContactFormRoundButton
